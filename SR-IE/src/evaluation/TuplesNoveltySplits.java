...
public class TuplesNoveltySplits {
	...
	public static void main(String[] args) throws IOException {
		...
		String usef_file = output_folder + "splits." + args[0] + ".useful";

		String outputFile = output_folder + "splits." + args[0] + ".novel";
		String outputFileSpls = output_folder + "splits." + args[0] + ".novel.splits";
		...
		while ((line = reader.readNext()) != null) {
			...
			if (!currelation.equals(line[relationi]) || !curextractor.equals(line[extractori]) || 
				...
				System.out.println(args[0] + " - " + data + " - " + extractor + " - " + relation);
